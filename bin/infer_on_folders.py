...
def main():
    ...
    result_path = os.path.join(args.output_dir, 'results/')  # "output_dir/result/"
        ...
        if args.enhancement == 'generator': 
            ...
            for style in styles_decomposition:
                ...
                for source_image in source_images_pil:
                    ...
                    out = style_transformer.transfer_images_to_styles(crops, [style], batch_size=args.batch_size, return_pil=False) # TODO : Current Point
